...
// 1y was tried with two strategies (single query and chunked-with-
// delays) but both deadlocked the tauri-plugin-sql IPC bridge on
// the consecutive selects the full year requires. 24w is the safe
// ceiling — users navigate older data with the ‹ › arrows.
