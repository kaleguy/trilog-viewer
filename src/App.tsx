  ...
  if (!db) {
    return (
      <main className="container">
        <h1>TriLog Viewer <span style={{ opacity: 0.5, fontSize: '0.7em', fontWeight: 400 }}>build perf-3</span></h1>
        <div className="card">
  ...
  return (
    <div className="app-shell">
      <header className="app-header">
        <h1 className="app-title">TriLog Viewer <span style={{ opacity: 0.5, fontSize: '0.7em', fontWeight: 400 }}>build perf-3</span></h1>
